...
import static com.trustai.notification_service.entity.NotificationCode.*;
...
public class NotificationTemplateDataInitializer {
    ...
    private List<NotificationTemplate> getEmailTemplates() {
        ...
        NotificationTemplate.email(WELCOME_EMAIL,
                        "Welcome, {{name}}",
    ...
    private List<NotificationTemplate> getSMSTemplates() {
        return List.of(
                NotificationTemplate.sms(OTP_SMS,
    ...
    private List<NotificationTemplate> getPushTemplates() {
        return List.of(
                NotificationTemplate.push(NEW_OFFER_PUSH,
