...
import com.trustai.notification_service.service.template.TemplateService;
import com.trustai.notification_service.service.template.TemplateServiceRegistry;
...
public class TemplateControllerHelper {
    ...
    public ResponseEntity<?> getTemplateByCode(String type, String code) {
        TemplateService<?> service = registry.getService(type);
        return ResponseEntity.ok(service.getTemplateByCode(code));
    }
}
