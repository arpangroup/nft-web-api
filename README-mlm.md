...
### ✅ 2. UserHierarchy (Closure Table for efficient depth-based queries)
````java
@Entity
...
### ✅ 5. UserPointSummary (calculated & cached points)
````java
@Entity
...
## ✅ 4. React Dashboard – User Tree with Points
