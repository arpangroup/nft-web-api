/*
package com.trustai.investment_service.client;
...
@ConditionalOnProperty(name = "feign.client.enabled.investment", havingValue = "true")
public interface InvestmentRankConfigClient extends RankConfigApi {
}
*/
